...
PLUGIN_NAME="EPS-16 Plus Prototype.vst3"
...
if [ -n "${EPS16_INSTALL_ROOT:-}" ]; then
  ...
  USE_SUDO=0
elif [ -d "/Library/Audio/Plug-Ins/VST3/$PLUGIN_NAME" ]; then
...
BINARY="$STAGE_PLUGIN/Contents/MacOS/EPS-16 Plus Prototype"
...
INCOMING="$INSTALL_ROOT/.EPS-16-Plus-Prototype.installing.$$"
BACKUP="$INSTALL_ROOT/EPS-16 Plus Prototype.vst3.backup-$(date +%Y%m%d-%H%M%S)"
